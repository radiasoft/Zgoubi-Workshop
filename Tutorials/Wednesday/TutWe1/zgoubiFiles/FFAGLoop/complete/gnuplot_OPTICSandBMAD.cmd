...
plot [s1:s2] [:180.] \
     ...
     'CBETA-4pass-20171020.lat_table'  u ($6-ds0):26  w l lw .8 lc rgb "red"  tit "{/Symbol b}_x bm"  ,\
     'CBETA-4pass-20171020.lat_table'  u ($6-ds0):32  w l lw .8 lc rgb "blue"  tit "{/Symbol b}_y bm"  ,\
     'CBETA-4pass-20171020.lat_table'  u ($6-ds0):30  axes x1y2 w l lw .8 lc rgb "black"  tit "{/Symbol h}_x bm"  ,\
     'CBETA-4pass-20171020.lat_table'  u ($6-ds0):36  axes x1y2 w l lw .8 lc rgb "brown"  tit "{/Symbol h}_y bm"  
